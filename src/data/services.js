export const SERVICES = [
  {
    ...
    description:
      'Multi-tenant SaaS platforms with subscription billing, RBAC, and dashboards built to scale from day one.',
  },
  {
    icon: 'ShoppingCart',
  ...
  },
  {
    ...
    description:
      'Operational dashboards with revenue statistics, user management, role-based access, and real-time data.',
  },
  {
    icon: 'Server',
    title: 'REST API Development',
    description:
      'Clean, documented, versioned APIs with proper auth, rate limiting, error handling, and third-party integrations.',
  },
  {
    icon: 'Plug',
  ...
  },
  {
    ...
    description:
      'Transform outdated websites into modern, fast, conversion-focused experiences that represent your brand.',
  },
  {
    icon: 'Zap',
...
export const FLAGSHIP_SERVICE = {
  ...
  points: [
    ...
    'Role-based access control built in, not bolted on',
    'Deployed, documented, and maintainable',
  ],
}